...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_collect_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_collect_t qt_meta_stringdata_collect = {
    {
QT_MOC_LITERAL(0, 0, 7), // "collect"
...
static const uint qt_meta_data_collect[] = {
...
QT_INIT_METAOBJECT const QMetaObject collect::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_collect.data,
    qt_meta_data_collect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *collect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_collect.stringdata0))
